...
public class UpcomingInteractor implements PopularContract.Interactor, Callback<MoviesResponse>  {
    ...
    @Inject
    public UpcomingInteractor(PopularContract.InteractorOutput interactorOutput,
